...
server.workspace('DQMContent', 42, 'Trigger/Lumi', 'HLT', '^HLT/', '',
                 ...
                 'HLT/ObjectMonitor/MainShifter/PAL1DoubleMu10_ZMass',
                 'HLT/ObjectMonitor/MainShifter/PAL2DoubleMu10_ZMass',
                 'HLT/ObjectMonitor/MainShifter/PAL3DoubleMu10_ZMass',
                 'HLT/ObjectMonitor/MainShifter/PAHIL3DoubleMu10_ZMass',
